...
export const stats = [
  ...
  { value: "16M", label: "Habitants recensés (PIGOR)" },
...
export const projects = [
  ...
  },
  {
    ...
    challenge: "Gérer le recensement de 16 millions d'habitants nécessitait un système robuste capable de coordonner 15 000+ agents de terrain, traiter des volumes massifs de données en temps réel, et assurer la fiabilité des résultats à l'échelle nationale.",
    solution: "Développement de 90% des modules de la plateforme : recrutement, commissions, paiements, préparation des données, rebasing, intégration NINEA. Système de suivi temps réel de la collecte avec tableau de bord pour les décideurs.",
    impact: [
      "16 millions d'habitants recensés avec succès",
      "15 000+ agents de terrain coordonnés en temps réel",
      "90% des modules développés en interne",

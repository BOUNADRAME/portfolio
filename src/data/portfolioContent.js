  ...
  fr: {
    projects: [
      ...
      },
      {
        ...
        subtitle: "Modernisation du Serveur Web Officiel CSPro (Beta)",
        client: "Projet Open Source Personnel — Afrique de l'Ouest",
        year: "2024-2025",
        category: "Open Source",
        description:
          "Projet open source de modernisation de CSWeb (serveur web officiel de CSPro) pour les opérations de recensement. Réduit le temps de setup de 2-3 jours à 5 minutes avec architecture multi-bases (PostgreSQL, MySQL, SQL Server). Version beta testée en production sur les recensements du Sénégal (3.2M questionnaires), Gambie et Guinée.",
        challenge:
          "L'installation CSWeb vanilla nécessitait 2-3 jours de configuration manuelle, supportait uniquement MySQL, et traitait les données globalement (48h pour 3.2M questionnaires). Les équipes techniques rencontraient des difficultés majeures de déploiement sans documentation moderne.",
        solution:
          "Création d'une plateforme Dockerisée open source avec CLI d'automatisation, architecture multi-bases optimisée pour l'analytique, breakout sélectif par dictionnaire (traite individuellement au lieu de globalement), webhooks pour workflows automatisés, monitoring temps réel, et documentation exhaustive. API REST avec OAuth2 pour intégrations tierces.",
        impact: [
          "3.2 millions de questionnaires traités en 6h (vs 48h avec CSWeb vanilla) lors du RGPH5 Sénégal",
          "Temps de setup réduit de 95% : 5 minutes au lieu de 2-3 jours",
          ...
          "Breakout sélectif : traitement par dictionnaire au lieu de global",
          "Documentation moderne complète avec guides de déploiement",
          "Architecture event-driven avec webhooks pour automatisation",
          "Contribution open source à l'écosystème CSPro",
        ],
        technologies: [
          "Docker",
          "PostgreSQL",
  ...
  en: {
    projects: [
      ...
      },
      {
        id: "csweb-community",
        title: "CSWeb Community Platform",
        subtitle: "Modernization of Official CSPro Web Server (Beta)",
        client: "Personal Open Source Project — West Africa",
        year: "2024-2025",
        category: "Open Source",
        description:
          "Open source project modernizing CSWeb (official web server for CSPro) for census operations. Reduces setup time from 2-3 days to 5 minutes with multi-database architecture (PostgreSQL, MySQL, SQL Server). Beta version tested in production on Senegal (3.2M questionnaires), Gambia and Guinea censuses.",
        challenge:
          "Vanilla CSWeb installation required 2-3 days of manual configuration, supported MySQL only, and processed data globally (48h for 3.2M questionnaires). Technical teams faced major deployment difficulties without modern documentation.",
        solution:
          "Creation of a Dockerized open source platform with automation CLI, multi-database architecture optimized for analytics, selective dictionary breakout (individual processing instead of global), webhooks for automated workflows, real-time monitoring, and comprehensive documentation. REST API with OAuth2 for third-party integrations.",
        impact: [
          "3.2 million questionnaires processed in 6h (vs 48h with vanilla CSWeb) during Senegal RGPH5",
          "95% setup time reduction: 5 minutes instead of 2-3 days",
          ...
          "Selective breakout: dictionary-based processing instead of global",
          "Comprehensive modern documentation with deployment guides",
          "Event-driven architecture with webhooks for automation",
          "Open source contribution to CSPro ecosystem",
        ],
        technologies: [
          "Docker",
          "PostgreSQL",

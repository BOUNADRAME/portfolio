    ...
    projects: [
      {
        ...
        description: "Plateforme IA d'analyse terrain multi-modale (texte, audio, images) pour l'USAID. Collecte mobile offline, analyse automatique de sentiment et génération de rapports PDF de résilience pour les décideurs. Intégration de 4 providers IA (Claude, Gemini, OpenAI, Ollama) avec réduction de coûts de 73%.",
        challenge: "Transformer les évaluations terrain qualitatives de producteurs agricoles en insights actionnables pour l'USAID. Besoin d'analyser automatiquement des observations multi-modales, classer les profils de résilience et générer des synthèses narratives, tout en respectant les contraintes d'offline-first et de validation humaine.",
        solution: "Stack enterprise : Spring Boot 3.5 (Java 25) + Next.js 16 + mobile Android offline. Intégration de 4 providers IA via Strategy Pattern pour flexibilité et optimisation des coûts. Cartographie interactive Leaflet, génération automatique de rapports PDF avec analyse thématique, et scheduler dynamique pour les tâches planifiées. Sécurité renforcée (JWT, RBAC, OWASP Top 10).",
        impact: [
      ...
      },
      {
        ...
        description: "Système de suivi terrain pour World Vision couvrant 11 types d'activités de santé communautaire. Plateforme web Symfony + app mobile Flutter offline-first pour les agents en zones à faible connectivité. Workflow de validation multi-niveaux et tableau de bord temps réel.",
        challenge: "Coordonner 11 types d'activités de santé communautaire à travers plusieurs districts sanitaires avec des agents terrain en zones à connectivité limitée. Les processus manuels rendaient impossible le suivi centralisé en temps réel.",
        solution: "Plateforme web Symfony 6.4 + API Platform couplée à une app mobile Flutter offline-first. Synchronisation automatique des données terrain via API REST sécurisée. Import/export Excel, génération de rapports PDF et tableau de bord statistique pour pilotage en temps réel.",
        impact: [
      ...
      },
      {
        ...
        year: "2025",
        category: "Open Data",
        description: "Première plateforme africaine francophone de diffusion de données statistiques conforme SDMX 3.0. Interopérable avec la Banque Mondiale, FMI, OCDE et Eurostat. Module IA pour requêtes en langage naturel et cartographie interactive des 14 régions du Sénégal.",
        challenge: "Moderniser la diffusion des données statistiques de l'ANSD avec un format standardisé international (SDMX 3.0), accessible au grand public comme aux chercheurs et organisations internationales.",
        solution: "Plateforme Spring Boot + Next.js avec export multi-formats (CSV, Excel, SDMX, Stata, SPSS), cartographie interactive, dashboards temps réel et système documentaire S3. Module IA (Llama 3) pour requêtes en langage naturel, rendant les données accessibles aux non-experts.",
        impact: [
    ...
    projects: [
      {
        ...
        technologies: ["Spring Boot 3.5", "Java 25", "PostgreSQL 16", "Flyway", "Claude AI (Haiku 4.5)", "Gemini Flash 2.0", "OpenAI GPT-4o-mini", "Ollama", "Next.js 16", "React 19", "TypeScript", "React Query", "Leaflet", "CSPro", "CSWeb", "PHP Webhooks", "Docker", "PDFBox 3.0", "JWT", "SSE", "Anthropic API"],
        hasScreenshots: true,
        isConfidential: true,
        color: "#8b5cf6",
      },
      {
        ...
        description: "Complete field activity tracking system for the WVLO Project, covering planning, execution and validation of community health activities across health districts and health posts. Web platform + offline-first Flutter mobile app for field agents.",
        challenge: "Coordinating community health activities (Optimized Community Dialogue and 10 other field activity types) across multiple health districts with agents operating in limited connectivity areas. Manual processes made real-time centralized tracking and reliable data reporting to decision-makers impossible.",
        solution: "Development of a full-stack web platform (Symfony 6.4 + API Platform 3.1) paired with an offline-first Flutter mobile app. The mobile app syncs field data as soon as connectivity is available via a JWT-secured REST API. The platform covers 11 operational modules with multi-level validation workflow, Excel import/export, PDF report generation and centralized statistical dashboard.",
        impact: [

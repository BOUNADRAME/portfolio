  ...
  en: {
    projects: [
      ...
      },
      {
        id: "pigor",
        title: "PIGOR",
        subtitle: "RGPH-5 Management Platform",
        client: "ANSD — Senegal",
        year: "2021-2024",
        category: "National Census",
        description: "Complete management system for Senegal's 5th General Population and Housing Census, covering the entire process: agent recruitment, commission management, payments, collection and statistical analysis.",
        ...
        solution: "Development of most critical platform modules: recruitment, commissions, payments, data preparation, rebasing, NINEA integration. Real-time collection tracking system with decision-maker dashboard.",
        impact: [
      ...
      },
      {
        ...
        year: "2024",
        category: "E-commerce",
        description: "Complete redesign of electronic distribution platform for Marjane and Electro Planete. Migration to modern microservices architecture to improve scalability and performance.",

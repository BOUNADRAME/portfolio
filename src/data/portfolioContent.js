  ...
  fr: {
    projects: [
      ...
      },
      {
        ...
        description: "Système complet de suivi des activités terrain du Projet WVLO, couvrant la planification, l'exécution et la validation des activités de santé communautaire à travers les districts sanitaires et postes de santé. Plateforme web + application mobile Flutter offline-first pour les agents terrain.",
        challenge: "Coordonner les activités de santé communautaire (Dialogue Communautaire Optimisé et 10 autres types d'activités terrain) à travers plusieurs districts sanitaires avec des agents opérant dans des zones à connectivité limitée. Les processus manuels rendaient impossible le suivi centralisé en temps réel et la remontée fiable des données vers les décideurs.",
        solution: "Développement d'une plateforme web full-stack (Symfony 6.4 + API Platform 3.1) couplée à une application mobile Flutter offline-first. L'app mobile synchronise les données terrain dès que la connexion est disponible via une API REST sécurisée JWT. La plateforme couvre 11 modules opérationnels avec workflow de validation multi-niveaux, import/export Excel, génération de rapports PDF et tableau de bord statistique centralisé.",
        impact: [

                ...
                {project.demoUrl && (
                  <div className="mb-6">
                    <a
                      ...
                      className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-primary-600 hover:bg-primary-500 text-white text-sm font-medium transition-all duration-300 hover:shadow-lg hover:shadow-primary-500/30"
                    >
                      <IconComponent name="ExternalLink" />
                      {language === 'fr' ? 'Voir la démo publique' : 'View public demo'}
                    </a>
                  </div>
                )}
